...
- `package.json`, `tsconfig.main.json`, `tsconfig.renderer.json`, `tsconfig.base.json`, `.gitignore`, `src/global.d.ts`, `index.html`: Added desktop toolchain bin/config and typing support needed for the shell baseline.
